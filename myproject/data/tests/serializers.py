...
from rest_framework_jwt.serializers import CompanySerializer
...
class CompanySerializerTests(TestCase):
    def setUp(self):
        self.name = 'jpueblo@example.com'
        self.address = 'jpueblo'
        self.phone = 'password'
    ...
    def test_create(self):
        serializer = CompanySerializer(data=self.data)
